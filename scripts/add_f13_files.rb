...
APP_SOURCES = [
  'JLPTDeck/Domain/SRS/ExportPayload.swift',
  'JLPTDeck/Features/Settings/JSONFileDocument.swift',
]

TEST_SOURCES = [
  'JLPTDeckTests/SRS/ExportPayloadTests.swift',
  'JLPTDeckTests/Data/ExportImportPersistenceTests.swift',
]
