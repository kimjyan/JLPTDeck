#!/usr/bin/env ruby
# G-CardView (F12+F16+F17): register new source + test files. Idempotent.
...
APP_SOURCES = [
  'JLPTDeck/Domain/SRS/PronunciationTraps.swift',
  'JLPTDeck/Shared/SpeechManager.swift',
]

TEST_SOURCES = [
  'JLPTDeckTests/SRS/PronunciationTrapsTests.swift',
]
