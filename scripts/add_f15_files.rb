...
APP_SOURCES = [
  'JLPTDeck/Data/Models/AppOpenEvent.swift',
  'JLPTDeck/Domain/SRS/RetentionStats.swift',
]

TEST_SOURCES = [
  'JLPTDeckTests/SRS/RetentionStatsTests.swift',
  'JLPTDeckTests/Data/AppOpenEventPersistenceTests.swift',
]
