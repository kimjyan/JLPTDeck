...
APP_SOURCES = [
  'JLPTDeck/Data/Models/UserOverride.swift',
  'JLPTDeck/Domain/SRS/HiddenCardFilter.swift',
]

TEST_SOURCES = [
  'JLPTDeckTests/SRS/HiddenCardFilterTests.swift',
  'JLPTDeckTests/Features/HideCardReducerTests.swift',
  'JLPTDeckTests/Data/HideCardPersistenceTests.swift',
]
